...
library SafeMath {
  ...
  function dmultiply(uint256 _a, uint256 _b, uint256 _d) internal pure returns (uint256) {
    uint256 c = _a.multiply(_b).add(_d.divide(2)).divide(_d);
    return c;
  }
  function ddivide(uint256 _a, uint256 _b, uint256 _d) internal pure returns (uint256) {
