...
library LogarithmLib {
    ...
    int256 public constant longer_fixed_log_e_1_5 =
        405465108108164381978013115464349137;
    int256 public constant longer_fixed_1 =
        1000000000000000000000000000000000000;
    int256 public constant longer_fixed_log_e_10 =
        2302585092994045684017991454684364208;
    ...
    function log_e(
        ...
        if (v == fixidity.fixed_e) {
            return
                fixidity.fixed_1 +
                FixidityLib.round_off(fixidity, r, extra_digits) /
                t;
        }
        v *= t;
